...
<div class="contentBlock">
  <div class="infoPane">
    ...
    <div class="infoPaneContents">
      <p>The database server stores the information about the sports clubs.</p>
  ...
  <div class="contentPane">
    ...
    <table border="0" width="99%" cellspacing="0" cellpadding="5" class="inputForm">
      <tr>
        <td class="inputField"><?php echo 'Database Server<br />' . wh_draw_input_field('DB_SERVER', 'localhost', 'class="text"'); ?></td>
        <td class="inputDescription">The address of the database server in the form of a hostname or IP address.</td>
      </tr>
      <tr>
        <td class="inputField"><?php echo 'Username<br />' . wh_draw_input_field('DB_SERVER_USERNAME', null, 'class="text"'); ?></td>
        <td class="inputDescription">The username used to connect to the database server.</td>
      </tr>
      <tr>
        <td class="inputField"><?php echo 'Password<br />' . wh_draw_password_field('DB_SERVER_PASSWORD', 'class="text"'); ?></td>
        <td class="inputDescription">The password that is used together with the username to connect to the database server.</td>
      </tr>
      <tr>
        <td class="inputField"><?php echo 'Database Name<br />' . wh_draw_input_field('DB_DATABASE', null, 'class="text"'); ?></td>
        <td class="inputDescription">The name of the database to hold the data in.</td>
      </tr>
      <tr>
        <td class="inputField"><?php echo 'Table prefix<br />' . wh_draw_input_field('DB_TABLE_PREFIX', null, 'class="text"'); ?></td>
        <td class="inputDescription">The table prefix, for shared databases.</td>
      </tr>
    </table>
